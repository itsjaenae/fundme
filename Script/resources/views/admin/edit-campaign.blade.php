		...
		@include('errors.errors-forms')
			...
			<div class="card shadow-custom border-0">
             ...
             @csrf
 		          ...
 		          <div class="col-sm-10">
 		            <img src="{{asset('campaigns/small').'/'.$data->small_image}}" width="180" class="rounded">
 		          </div>
 		        </div>
...
@section('javascript')
<script src="{{ asset('js/ckeditor-init.js') }}?v={{$settings->version}}" type="text/javascript"></script>
@endsection
