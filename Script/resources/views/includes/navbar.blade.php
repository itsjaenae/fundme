<div class="btn-block text-center showBanner py-2" style="display:none;background: #333 !important">
...
<header >
  <nav class="navbar navbar-expand-lg navbar-inverse fixed-top py-3 @if(request()->path() == '/') scroll @else shadow-sm bg-dark @endif" 
    style="background: #000 !important; height: 75px;">
    <div class="container d-flex fw-bold">
      <a class="navbar-brand" href="{{ url('/') }}">
        {{-- style="max-width: 100px;" --}}
        <img width="130px" height="55px" src="{{ asset('img/logo.png') }}" class="align-baseline" alt="{{$settings->title}}" />
      </a>
