...
<div class="card mb-4 shadow-sm">
	...
	@endif
		<img class="card-img-top" src="{{ asset('campaigns/small').'/'.$response->small_image }}" alt="{{ $response->title }}">
	</a>
	<div class="card-body">
		...
		<div class="d-flex justify-content-between align-items-center">
			<span class="text-truncate">
				<img src="{{ asset('avatar').'/'.$response->user()->avatar }}" width="25" height="25" class="rounded-circle avatar-campaign">
